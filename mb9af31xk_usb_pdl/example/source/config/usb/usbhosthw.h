...
#define HOST0VBUS_INIT                                    FM3_GPIO->DDR1 |= (1 << 3); FM3_GPIO->ADE &= ~(1 << 3)
...
#define HOST0OTGPULLDOWN_INIT                             FM3_GPIO->DDR1 |= (1 << 0x02); FM3_GPIO->ADE &= ~(1 << 2)
...
#define HOST0OVERCURRENT_ISRISSET                         
