 ...
 **  - 2015-05-05    2.5  MSCH  Fixed reading number of configurations from offset 11 instead of 17 
 **  - 2015-07-21    2.6  MSCH  Documentation updated
 *****************************************************************************/
...
void ReturnedDeviceDescriptor(stc_usbn_t* pstcUsb,uint8_t* pu8Buffer, uint32_t u32DataSize)
{
    ...
    pstcUsbHostClassSupervisorIntern->u8MaxConfigurations = pu8Buffer[17];
    //stcSetup.wValue |= 1;
