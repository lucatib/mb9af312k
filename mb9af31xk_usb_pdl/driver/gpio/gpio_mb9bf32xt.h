 ...
 **
 ** Header file for MB9BF32XT GPIO functions, included in gpio.h
 **
 ** History:
 ...
 **
 ** Timestamp:
 **   - 2016-05-11 09:17:27  Auto created by GpioHeaderGenerator Rev 1.0.4
 **
 ******************************************************************************/
...
/*--- DA0_0 ---*/
#define SetPinFunc_DA0_0(dummy)         do{ \
		/* bFM_DAC_DACR0_DAE = 1u;*/ \
                                        }while (0u)

/*--- DA1_0 ---*/
#define SetPinFunc_DA1_0(dummy)         do{ \
 		/* bFM_DAC_DACR1_DAE = 1u;*/ \
                                        }while (0u)
