 ...
 **
 ** Header file for MB9BFD1XT GPIO functions, included in gpio.h
 **
 ** History:
 ...
 **
 ** Timestamp:
 **   - 2016-05-11 09:17:28  Auto created by GpioHeaderGenerator Rev 1.0.4
 **
 ******************************************************************************/
...
#define GPIO1PIN_P7F_INITIN(v)          do{ \
                                            bFM_GPIO_PCR7_PF=(v).bPullup; \
                                            bFM_GPIO_DDR7_PF=0u; \
                                            bFM_GPIO_PFR7_PF=0u; }while(0u)

#define GPIO1PIN_P7F_INITOUT(v)         do{ \
                                            bFM_GPIO_PDOR7_PF=(v).bInitVal; \
                                            bFM_GPIO_DDR7_PF=1u; \
                                            bFM_GPIO_PFR7_PF=0u; }while(0u)
...
#define GPIO1PIN_NP7F_INITIN(v)         do{ \
                                            bFM_GPIO_PCR7_PF=(v).bPullup; \
                                            bFM_GPIO_DDR7_PF=0u; \
                                            bFM_GPIO_PFR7_PF=0u; }while(0u)

#define GPIO1PIN_NP7F_INITOUT(v)        do{ \
                                            bFM_GPIO_PDOR7_PF=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                            bFM_GPIO_DDR7_PF=1u; \
                                            bFM_GPIO_PFR7_PF=0u; }while(0u)
...
#define GPIO1PIN_PD3_INITIN(v)          do{ \
                                            bFM_GPIO_PCRD_P3=(v).bPullup; \
                                            bFM_GPIO_DDRD_P3=0u; \
                                            bFM_GPIO_PFRD_P3=0u; }while(0u)

#define GPIO1PIN_PD3_INITOUT(v)         do{ \
                                            bFM_GPIO_PDORD_P3=(v).bInitVal; \
                                            bFM_GPIO_DDRD_P3=1u; \
                                            bFM_GPIO_PFRD_P3=0u; }while(0u)
...
#define GPIO1PIN_NPD3_INITIN(v)         do{ \
                                            bFM_GPIO_PCRD_P3=(v).bPullup; \
                                            bFM_GPIO_DDRD_P3=0u; \
                                            bFM_GPIO_PFRD_P3=0u; }while(0u)

#define GPIO1PIN_NPD3_INITOUT(v)        do{ \
                                            bFM_GPIO_PDORD_P3=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                            bFM_GPIO_DDRD_P3=1u; \
                                            bFM_GPIO_PFRD_P3=0u; }while(0u)
...
/*--- E_COL0 ---*/
#define SetPinFunc_E_COL0(dummy)        do{ \
                                            bFM_GPIO_PFRC_P9 = 1u; \
                                        }while (0u)
...
/*--- E_CRS0 ---*/
#define SetPinFunc_E_CRS0(dummy)        do{ \
                                            bFM_GPIO_PFRC_PA = 1u; \
                                        }while (0u)

/*--- E_MDC0 ---*/
#define SetPinFunc_E_MDC0(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 22u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_P7 = 1u; \
                                        }while (0u)

/*--- E_MDIO0 ---*/
#define SetPinFunc_E_MDIO0(dummy)       do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 24u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_P6 = 1u; \
                                        }while (0u)

/*--- E_MDIO1 ---*/
#define SetPinFunc_E_MDIO1(dummy)       do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 25u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PC = 1u; \
                                        }while (0u)

/*--- E_PPS0_PPS1 ---*/
#define SetPinFunc_E_PPS0_PPS1(dummy)   do{ \
...
/*--- E_RX02_RX10 ---*/
#define SetPinFunc_E_RX02_RX10(dummy)   do{ \
                                            bFM_GPIO_PFRC_P2 = 1u; \
                                        }while (0u)

/*--- E_RX03_RX11 ---*/
#define SetPinFunc_E_RX03_RX11(dummy)   do{ \
                                            bFM_GPIO_PFRC_P1 = 1u; \
                                        }while (0u)

/*--- E_RXCK0_REFCK ---*/
#define SetPinFunc_E_RXCK0_REFCK(dummy) do{ \
                                            bFM_GPIO_PFRC_P8 = 1u; \
                                        }while (0u)

/*--- E_RXDV0 ---*/
#define SetPinFunc_E_RXDV0(dummy)       do{ \
                                            bFM_GPIO_PFRC_P5 = 1u; \
                                        }while (0u)

/*--- E_RXER0_RXDV1 ---*/
#define SetPinFunc_E_RXER0_RXDV1(dummy) do{ \
                                            bFM_GPIO_PFRC_P0 = 1u; \
                                        }while (0u)

/*--- E_TCK0_MDC1 ---*/
#define SetPinFunc_E_TCK0_MDC1(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 23u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PD = 1u; \
                                        }while (0u)
...
/*--- E_TX02_TX10 ---*/
#define SetPinFunc_E_TX02_TX10(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 19u, 1u,  1u ); \
                                            bFM_GPIO_PFRD_P0 = 1u; \
                                        }while (0u)

/*--- E_TX03_TX11 ---*/
#define SetPinFunc_E_TX03_TX11(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 19u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PF = 1u; \
                                        }while (0u)

/*--- E_TXEN0 ---*/
#define SetPinFunc_E_TXEN0(dummy)       do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 20u, 1u,  1u ); \
                                            bFM_GPIO_PFRD_P3 = 1u; \
                                        }while (0u)

/*--- E_TXER0_TXEN1 ---*/
#define SetPinFunc_E_TXER0_TXEN1(dummy) do{ \
...
/*--- SCK6_2 ---*/
#define SetPinFunc_SCK6_2(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 20u, 2u,  3u ); \
                                            bFM_GPIO_PFRF_P5 = 1u; \
                                        }while (0u)
...
/*--- SIN6_2 ---*/
#define SetPinFunc_SIN6_2(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 16u, 2u,  3u ); \
                                            bFM_GPIO_PFRF_P3 = 1u; \
                                        }while (0u)
...
/*--- SOT6_2 ---*/
#define SetPinFunc_SOT6_2(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR08, 18u, 2u,  3u ); \
                                            bFM_GPIO_PFRF_P4 = 1u; \
                                        }while (0u)
...
/*--- TIOA07_1_OUT ---*/
#define SetPinFunc_TIOA07_1_OUT(dummy)  do{ \
                                            bFM_GPIO_ADE_AN30=0u; \
...
/*--- TIOA07_2_IN ---*/
#define SetPinFunc_TIOA07_2_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 24u, 2u,  3u ); \
                                            bFM_GPIO_PFR7_P6 = 1u; \
                                        }while (0u)

/*--- TIOA07_2_OUT ---*/
#define SetPinFunc_TIOA07_2_OUT(dummy)  do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 26u, 2u,  3u ); \
                                            bFM_GPIO_PFR7_P6 = 1u; \
                                        }while (0u)

/*--- TIOA08_0_OUT ---*/
#define SetPinFunc_TIOA08_0_OUT(dummy)  do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 2u, 2u,  1u ); \
                                            bFM_GPIO_PFRA_P0 = 1u; \
                                        }while (0u)

/*--- TIOA08_1_OUT ---*/
#define SetPinFunc_TIOA08_1_OUT(dummy)  do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 2u, 2u,  2u ); \
                                            bFM_GPIO_PFRF_P1 = 1u; \
                                        }while (0u)

/*--- TIOA08_2_OUT ---*/
#define SetPinFunc_TIOA08_2_OUT(dummy)  do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 2u, 2u,  3u ); \
                                            bFM_GPIO_PFRC_P4 = 1u; \
                                        }while (0u)

/*--- TIOA09_0_IN ---*/
#define SetPinFunc_TIOA09_0_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 8u, 2u,  1u ); \
                                            bFM_GPIO_PFRA_P1 = 1u; \
                                        }while (0u)

/*--- TIOA09_0_OUT ---*/
#define SetPinFunc_TIOA09_0_OUT(dummy)  do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 10u, 2u,  1u ); \
                                            bFM_GPIO_PFRA_P1 = 1u; \
                                        }while (0u)

/*--- TIOA09_1_IN ---*/
#define SetPinFunc_TIOA09_1_IN(dummy)   do{ \
                                            bFM_GPIO_ADE_AN16=0u; \
...
/*--- TIOA09_1_OUT ---*/
#define SetPinFunc_TIOA09_1_OUT(dummy)  do{ \
                                            bFM_GPIO_ADE_AN16=0u; \
...
/*--- TIOA09_2_IN ---*/
#define SetPinFunc_TIOA09_2_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 8u, 2u,  3u ); \
                                            bFM_GPIO_PFR5_P6 = 1u; \
                                        }while (0u)

/*--- TIOA09_2_OUT ---*/
#define SetPinFunc_TIOA09_2_OUT(dummy)  do{ \
...
/*--- TIOB07_2_IN ---*/
#define SetPinFunc_TIOB07_2_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR05, 28u, 2u,  3u ); \
                                            bFM_GPIO_PFR7_P7 = 1u; \
                                        }while (0u)

/*--- TIOB08_0_IN ---*/
#define SetPinFunc_TIOB08_0_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u,  1u ); \
                                            bFM_GPIO_PFR9_P0 = 1u; \
                                        }while (0u)

/*--- TIOB08_1_IN ---*/
#define SetPinFunc_TIOB08_1_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u,  2u ); \
                                            bFM_GPIO_PFRF_P2 = 1u; \
                                        }while (0u)

/*--- TIOB08_2_IN ---*/
#define SetPinFunc_TIOB08_2_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 4u, 3u,  3u ); \
                                            bFM_GPIO_PFRC_PF = 1u; \
                                        }while (0u)

/*--- TIOB09_0_IN ---*/
#define SetPinFunc_TIOB09_0_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR12, 12u, 2u,  1u ); \
                                            bFM_GPIO_PFR9_P1 = 1u; \
                                        }while (0u)

/*--- TIOB09_1_IN ---*/
#define SetPinFunc_TIOB09_1_IN(dummy)   do{ \
                                            bFM_GPIO_ADE_AN17=0u; \
...
/*--- TIOB09_2_IN ---*/
#define SetPinFunc_TIOB09_2_IN(dummy)   do{ \
...
#define SetPinFunc_TIOB12_0_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR13, 4u, 3u,  1u ); \
                                            bFM_GPIO_PFR9_P4 = 1u; \
                                        }while (0u)
...
#define SetPinFunc_TIOB12_1_IN(dummy)   do{ \
                                            bFM_GPIO_ADE_AN23=0u; \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR13, 4u, 3u,  2u ); \
                                            bFM_GPIO_PFRB_P7 = 1u; \
                                        }while (0u)

/*--- TIOB12_2_IN ---*/
#define SetPinFunc_TIOB12_2_IN(dummy)   do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR13, 4u, 3u,  3u ); \
                                            bFM_GPIO_PFR3_P7 = 1u; \
                                        }while (0u)
