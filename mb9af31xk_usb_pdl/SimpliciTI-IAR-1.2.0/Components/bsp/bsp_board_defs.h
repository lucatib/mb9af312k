...
#define __bsp_ISR_FUNCTION_ENTER__()	 
#define __bsp_ISR_FUNCTION_EXIT__()		 
#define __bsp_ENABLE_INTERRUPTS__()       		
#define __bsp_DISABLE_INTERRUPTS__()	  
#define __bsp_RESTORE_ISTATE__(x)  		 
 
#define __bsp_ISR_FUNCTION__(func,vect)	  	
#define __bsp_INTERRUPTS_ARE_ENABLED__()  	
#define __bsp_INTERRUPTS_ARE_DISABLED__()  	
#define __bsp_ISTATE_T__            	  	int	//unsigned short
...
#ifdef SINGLE_TEST
	#define  SMPL_MAIN main 
#else 
	#define SMPL_MAIN smpl_main
#endif 
 ...
 */
  ...
  #elif BSP_TIMER_USED == BSP_TIMER_B7
