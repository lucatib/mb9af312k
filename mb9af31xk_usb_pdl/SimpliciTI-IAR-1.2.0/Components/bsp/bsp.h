...
extern volatile stc_mfsn_csio_t* CsioCh0;
extern uint8_t au8CsioMasterTxBuf[SAMPLE_CSIO_MASTER_TX_BUFFSIZE];
extern uint8_t au8CsioMasterRxBuf[SAMPLE_CSIO_MASTER_RX_BUFFSIZE];
extern stc_tx_fifo_info_t stcTxFifoInfo;
extern stc_rx_fifo_info_t stcRxFifoInfo;
...
#define BSP_ISR_FUNCTION_EXIT()     	__bsp_ISR_FUNCTION_EXIT__()
#define BSP_ISR_FUNCTION_ENTER()     	__bsp_ISR_FUNCTION_ENTER__()
...
#define BSP_INTERRUPTS_ARE_DISABLED()   __bsp_INTERRUPTS_ARE_DISABLED__()
...
#define BSP_CRITICAL_STATEMENT(x)       st( bspIState_t s;                    \
	...
	#define BSP_ENTER_CRITICAL_SECTION(x)  
	#define BSP_EXIT_CRITICAL_SECTION(x)   
	#define BSP_CRITICAL_STATEMENT(x)
