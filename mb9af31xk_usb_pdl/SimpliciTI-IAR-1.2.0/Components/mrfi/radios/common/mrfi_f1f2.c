 ...
 */
		...
		static const uint8_t mrfiLogicalChanTable[] = // Agility + randomized version
		{
			SMARTRF_SETTING_CHANNR,	103,	202,	212, 	156,
		   	12, 	172, 	132,	92,  	36,
		  	148, 	108, 	164, 	68, 	180,
		   	52,  	76, 	140, 	116, 	100,
		   	28, 	196,  	60, 	188, 	124
		};	
	#elif defined(FREQUENCY_HOPPING)
...
extern void Mrfi_RxModeOn(void);	/* this called from mrfi_f1f2.c */	
extern void Mrfi_RxModeOff(void);	/* this called from mrfi_f1f2.c */
extern volatile uint8_t mrfiRadioState;
/**************************************************************************************************
